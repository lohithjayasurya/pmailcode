...
public class pasupdation2 extends AppCompatActivity {
    String username;
    EditText e5,e6;
    Button b1;
    TextView t1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pasupdation2);
                ...
                if(!(x.isEmpty())){
                    if(!(y.isEmpty())){
                        if(x.length()>=8){
                            if(y.length()>=8){
                                if(x.equals(y)){
                                    final RequestQueue queue = Volley.newRequestQueue(pasupdation2.this);
                                            ...
                                            new Response.Listener<JSONObject>() {
                                                ...
                                                public void onResponse(JSONObject response) {
                                                    try {
                                                        ...
                                                        Intent i=new Intent(pasupdation2.this,update_profile.class);
                                                        startActivity(i);
                                                        finishAffinity();
