...
public class messages1 extends AppCompatActivity implements View.OnClickListener {
    TextView e1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_messages1);
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.button11) {
            ...
            final String url = "https://p-mail.herokuapp.com/deleteCom"; // your URL
                    ...
                    new Response.Listener<JSONObject>() {
                        ...
                        public void onResponse(JSONObject response) {
                            try {
                                ...
                                Toast.makeText(messages1.this, "mail deleted", Toast.LENGTH_SHORT).show();
                                Intent i5 = new Intent(messages1.this, sent.class);
                                startActivity(i5);
                                finishAffinity();
