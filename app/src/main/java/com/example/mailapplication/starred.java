...
public class starred extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ListView lv;
    int n;
    String[] messages;
    String[] newmessages;
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            ada = new ArrayAdapter<String>(starred.this,android.R.layout.simple_list_item_1,newmessages);
                            lv.setAdapter(ada);
                            lv.setOnItemClickListener(starred.this);
